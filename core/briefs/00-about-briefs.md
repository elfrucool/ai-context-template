...
- After a feature spanning 3+ session files
- After a significant architectural change
- Before handing off work to another agent or developer

See `guidelines/BRIEF_CREATION_GUIDELINES.md` for the full process.
